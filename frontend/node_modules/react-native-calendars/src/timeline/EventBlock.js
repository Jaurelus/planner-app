...
const EventBlock = (props) => {
    ...
    const eventStyle = useMemo(() => {
        return {
            ...
            width: event.width,
            top: event.top,
            borderColor: event.color ? event.color : EVENT_DEFAULT_COLOR,
            borderWidth: 2,
    ...
    return (<TouchableOpacity clas testID={props.testID} activeOpacity={0.9} onPress={_onPress} style={[styles.event, eventStyle]}>
