...
`;
        try {
            ...
            console.error(chalk_1.default.red('✗'), 'Failed to create config file:', error instanceof Error ? error.message : String(error));
            return false;
        }
    });
}
...
function readConfig() {
    ...
    try {
        ...
        console.warn(chalk_1.default.yellow('!'), 'Config file not found, using defaults:', error instanceof Error ? error.message : String(error));
