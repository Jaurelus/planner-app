...
function initCommand() {
    return __awaiter(this, arguments, void 0, function* (options = {}) {
        ...
        if (!options.skipInstall) {
            yield installEssentialDependencies();
        }
        // Create utility files (not modifying existing ones)
        yield createUtilityFiles();
        console.log();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (yield fs_extra_1.default.pathExists(userPresetPath)) {
                console.log(chalk_1.default.blue('i'), 'nativecn-preset.js already exists');
                return true;
            }
            // Copy the preset file from our templates
            const presetTemplatePath = path_1.default.resolve(__dirname, '../../templates/preset.js');
            if (yield fs_extra_1.default.pathExists(presetTemplatePath)) {
                yield fs_extra_1.default.copyFile(presetTemplatePath, userPresetPath);
    ...
    extend: {
      ...
      borderRadius: {
        ...
        sm: 6,
            ...
            console.error(chalk_1.default.red('✗'), 'Failed to create nativecn-preset.js:', error instanceof Error ? error.message : String(error));
            return false;
        }
    });
}
